...
Science}
    ...
    the effect of cometary impact-generated fractures on the transport
...
\textit{National Security Earth Science Group (EES-17), Los Alamos National Laboratory}
    ...
    Serving as a PI on a successfully-funded LDRD CSES Rapid Response R\&D grant proposal
    (see \hyperref[sec:funding]{Research Funding}) which aims to pursue
    work modeling hypervelocity comet impacts on Titan and the potential for
