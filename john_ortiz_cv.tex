...
%\begin{adjustwidth}{5pt}{0pt}
%\end{adjustwidth}
\years{2020}R\&D 100 Award Finalist (\emph{Amanzi-ATS}), Contributor
\begin{adjustwidth}{5pt}{0pt}
...
\years{2020}\textsc{*CSES Rapid Response Research \& Development Program, Planetary
Science}
\begin{adjustwidth}{5pt}{0pt}
	Seed funding for preliminary work and proof-of-concept results of methane
	transport in fractured rock environments on Mars influenced by periodic
	barometric pressure variations.	
	PI: Dylan Harp (LANL). Co-PIs: Roger Wiens (LANL), Harihar Rajaram (JHU),
...
\begin{adjustwidth}{5pt}{0pt}
	...
	environmental cleanup and closure of waste sites. This software was named
	an R\&D 100 Award program finalist in September 2020.
\end{adjustwidth}
...
\emph{Solid Earth Discussions}. doi:10.5194/se-2020-20 (in review).\\
