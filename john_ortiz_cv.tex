...
\noindent
\years{2023}SAM-TLS Experiment Proposal, Co-author
\begin{adjustwidth}{5pt}{0pt}
	Co-authored proposal with members of SAM-TLS team proposing strategic
timing of atmospheric sample experiments for \textit{Curiosity} rover to
perform in order to constrain sub-diurnal methane variations at Gale crater,
Mars. \textit{Curiosity} successfully performed one of the proposed experiments
23 September, 2023.
\end{adjustwidth}
...
Sub-diurnal methane variations on Mars driven by barometric pumping and
planetary boundary layer evolution. 
\emph{Journal of Geophysical Research: Planets} (under review).\\ 
...
media, oral presentation. InterPore 10\textsuperscript{th} Annual Meeting in New Orleans, LA (May
2018).\\
...
(presenting for Dylan Harp). InterPore 10\textsuperscript{th} Annual Meeting in
