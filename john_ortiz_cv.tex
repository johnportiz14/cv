...
Science}
    ...
    of organics from Titan's surface to its subsurface ocean. 
    \textbf{PI: John Ortiz} (LANL); Co-Is: Esteban Rougier (LANL), Phil
    Stauffer (LANL) Total: \$60k (\$55k).\\
...
\years{2021-2024}\textsc{*CSES Student Fellowship, Planetary Science}
    ...
    mixing model implemented in Python.
...
Science}
    ...
    PI: Dylan Harp (LANL); \textbf{Student: John Ortiz} (JHU-LANL); Co-Is: Roger Wiens
