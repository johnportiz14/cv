...
\textit{National Security Earth Science Group (EES-17), Los Alamos National Laboratory}
    ...
    On conversion to Director's Fellow, I used the remainder of
    the funding remaining from the CSES Rapid Response R\&D grant (see
    \hyperref[sec:funding]{Research Funding}) to hire and serve as a co-mentor
    for a summer PhD student to carry out tasks on our Titan hypervelocity
    impacts project. 
