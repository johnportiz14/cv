...
\textit{National Security Earth Science Group (EES-17), Los Alamos National Laboratory}
    ...
    Began postdoc in June 2024. Serving as a PI on a successfully-funded LDRD
    CSES Rapid Response R\&D grant proposal (see
    \hyperref[sec:funding]{Research Funding}) which aims to pursue work
    modeling hypervelocity comet impacts on Titan and the potential for
    surface-to-ocean exchange of organic material through the generated
    fracture networks. This grant is funding my research at $\sim$40\% FTE for
    one year. 
    % Current tasks include implementing the analytical equation of
    % state (ANEOS) formulation in the HOSS software suite    (see
...
\noindent
\years{2025}\textbf{Ortiz, J. P.}, Lucero, D. D.,  Bourret, S. M., Fritz, B.
G., Bodmer, M. A., Heath, J., Neil, C. W., Boukhalfa, H., Kuhlman, K., Otto,
S., Ezzedine, S., Robert, B. L., Choens, R. C., Person, M. A., Stauffer, P. H.,
The PE1 Team. 
...
%
 ...
 Miller, T. A., Heinrichs, Hinrichs, E. L., \textbf{Ortiz, J. P.}, Stauffer, P.
 H.
