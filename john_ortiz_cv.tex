...
Science}
    ...
    on organics transport in Titan's crust.}\\
    LDRD seed funding for preliminary work and proof-of-concept results studying 
    the effect of cometary hypervelocity impact-generated fractures on the transport
    of organics from Titan's surface to its subsurface ocean. Project: 20258051CT-SES. 
    \textbf{PI: John Ortiz} (LANL); Co-Is: Esteban Rougier (LANL), Phil
    Stauffer (LANL).  Total: \$60k (\$60k).\\
...
\textit{National Security Earth Science Group (EES-17), Los Alamos National Laboratory}
    ...
    Serving as a PI on a successfully-funded LDRD CSES Rapid Response R\&D
    ...
    one year. Current tasks include implementing the analytical equation of
...
(\href{https://www.lanl.gov/engage/organizations/cels/ees-division/scientific-software/hoss}{https://www.lanl.gov/engage/organizations/cels/ees-division/scientific-software/hoss}
    to investigate hypervelocity comet impacts on Earth and Titan. Augmented
    capability of the HOSS code by implementing the analytical equation of
    state (ANEOS) formulation to account for rapid phase changes under shocked
    conditions and a greater range of pressure and temperature conditions.
    These code modifications will improve the Lab's capability to model
    underground nuclear and chemical explosions taking place under a wider
    range of conditions.  
